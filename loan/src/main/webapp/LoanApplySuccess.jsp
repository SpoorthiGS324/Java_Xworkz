...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<h3>Loan Application Info Saved Successfully....</h3>
	 Name is : ${name}<br><br>
	 Amount : ${amount}<br><br>
	 Working : ${working}<br><br>
	 Interest : ${interest}<br><br>
	 Surety : ${surety}<br><br>
	 Company : ${company}<br><br>
	 loanTenure : ${loanTenure}<br><br>
	 loanType : ${loanType}<br><br>
	 AcceptTerm : ${acceptTerm}<br><br>
