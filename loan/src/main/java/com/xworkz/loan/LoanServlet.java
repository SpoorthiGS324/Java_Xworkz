...
@WebServlet(urlPatterns = "/loanInfo", loadOnStartup = 3)
public class LoanServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("Running doPost in LoanServlet");
		...
		String acceptTerm = req.getParameter("term");
		...
		req.setAttribute("acceptTerm", acceptTerm);
